// Brand mark: the amber waveform lifted from the official MilitaryVoices.ai
...
export function Wordmark({ className = "" }: { className?: string }) {
  return (
    <span className={`font-bold tracking-tight ${className}`} style={{ fontFamily: "'General Sans', 'Inter', sans-serif" }}>
      <span className="text-[#000741] dark:text-white">MilitaryVoices</span>
...
export function LogoLockup({ className = "h-14 lg:h-[72px]" }: { className?: string }) {
  return (
    <>
      <img src="/logo-lockup.png?v=4" alt="MilitaryVoices.ai" className={`w-auto dark:hidden ${className}`} />
      <img src="/logo-lockup-dark.png?v=4" alt="MilitaryVoices.ai" className={`hidden w-auto dark:block ${className}`} />
    </>
  );
}
...
export function LogoLockupOnDark({ className = "h-14" }: { className?: string }) {
  return <img src="/logo-lockup-dark.png?v=4" alt="MilitaryVoices.ai" className={`w-auto ${className}`} />;
}
